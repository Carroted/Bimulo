// thanks to https://github.com/vrd/js-intersect (MIT license)
...
function edgify(fig1, fig2) {
    ...
    for (var i = 0; i < primEdges.length; i++) {
        ...
        var startPoint = primEdges[i][0];
        startPoint.t = 0;
        var endPoint = primEdges[i][1];
        endPoint.t = 1;
...
function getMidpoints(edges) {
    ...
    for (var i = 0; i < edges.length; i++) {
        ...
        var classify = classifyPoint({ x: x, y: y }, edges[i]);
